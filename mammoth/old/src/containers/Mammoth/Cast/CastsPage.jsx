...
import FilmsList from './CastsList.jsx'
           ...
           <div>
                    ...
                    height:this.context.muiTheme.palette.desktopSubheaderHeight}}
                       ...
                       <ToolbarGroup>
                           <Tabs
                               ...
                               >
                               <Tab label="演员" value={0}/>
                               <Tab label="导演" value={1}/>
                               <Tab label="编剧" value={2} />
                           </Tabs>
                       </ToolbarGroup>
               ...
               <div style={styles.content}>
                   ...
                   <SwipeableViews
                       ...
                       >
                       <div>
                           <FilmsList catalogue='actor'/>
                       </div>
                       <div>
                           <FilmsList catalogue='director'/>
                       </div>
                       <div >
                           <FilmsList catalogue='screenwriter'/>
                       </div>
                   </SwipeableViews>
               </div>
           </div>
