...
export default class CompositeValue extends React.Component
{
    ...
    render( ) {
        return (
            <div>
                <div style={{marginTop:0,width:200,height:150}}>
                    <Toolbar style={{height:35}}>
                        <ToolbarGroup
                            //firstChild={true}
                            >
                            <ToolbarTitle text="影响力" style={{marginTop:-10,marginLeft:-5,fontSize:14,color:'F9A825'}}/>
                ...
                <div style={{margin:'10 20px',fontSize:12,lineHeight:1.5,width:170}}>
                    出生地：山东青岛<br/>
                    出生日期：1974/8/26<br/>
                    星座：处女座<br/>
                    血型：O型<br/>
                    身高：172cm<br/>
                    毕业学校：北京电影学院表演系配音专业<br/>
                </div>
            </div>
        );
    }
