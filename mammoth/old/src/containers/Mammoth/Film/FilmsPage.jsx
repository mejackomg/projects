           ...
           <div>
                    ...
                    height:this.context.muiTheme.palette.desktopSubheaderHeight}}
                       ...
                       <ToolbarGroup>
                           <Tabs
                               ...
                               >
                               <Tab label="正在热映" value={0}/>
                               <Tab label="即将上映" value={1}/>
                               <Tab label="影片库" value={2} />
                           </Tabs>
                       </ToolbarGroup>
               ...
               <div style={styles.content}>
                   ...
                   <SwipeableViews
                       ...
                       >
                       <div>
                           <FilmsList catalogue='living'/>
                       </div>
                       <div>
                           <FilmsList catalogue='upcoming'/>
                       </div>
                       <div >
                           <FilmsList catalogue='history'/>
                       </div>
                   </SwipeableViews>
               </div>
           </div>
...
FilmsPage.contextTypes = {
    muiTheme: React.PropTypes.object,
}

FilmsPage.childContextTypes = {
    muiTheme: React.PropTypes.object,
};
