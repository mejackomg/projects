...
import { loadTransTable,QueryUserManageTable,loadUserManagebyText} from '../../../reducers/database.js';
...
class UserManagePage extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        /*else if (nextProps.updateUserResult && this.props.updateUserResult != nextProps.updateUserResult) {
            const {success,data,error} = nextProps.updateUserResult;

            this.setState({
                snackbarOpen: true,
                snackbarMessage: success ? "Database updated successfully" : "Failed to update database:该用户不存在 " + error
            });

            this.props.dispatch(QueryUserManageTable('','',''));
        }
        else if (nextProps.updateUserError) {
            const {success,error} = nextProps.updateUserError;
        ...
        else if (nextProps.deleteUserManageTableResult) {
            const {success,error} = nextProps.deleteUserManageTableResult;
        ...
        else if (nextProps.deleteUserManageTableError) {
            const {success,error} = nextProps.deleteUserManageTableError;
...
const mapStateToProps = (state) => {
    ...
    return {
       ...
       // mappingData: databaseReducer.tableData.mappingData,
        ...
        //addNewUserDataError: databaseReducer.addNewUserDataError,
        //updateUserResult: updateUserResult,
        //updateUserError: databaseReducer.updateUserError,
        //deleteUserManageTableResult:databaseReducer.deleteUserManageTableResult,
       //deleteUserManageTableError:databaseReducer.deleteUserManageTableError,
