                ...
                <Paper style={styles.style} zDepth={2}>
                    ...
                    <div style={{display:'flex',flexDirection:'row',paddingTop:'30px',paddingLeft:'100px'}}>
                        ...
                        <div style={{width:'30%',color:'#000000',fontSize:'16px'}}>
                            <span>商户销售总金额数:</span><br />
                            <span>商户平均销售金额：</span><br />
                            <span>商户总体评价：</span><br />
                        </div>
                    ...
                    <Paper style={{margin:'10px 30px'}}>
                        <Tabs
                            ...
                            <Tab label="总订单数" value={1} style={{color:'#000000'}}>
                                <div style={{width:'100%',height:'350px',textAlign:'center'}}>
                                    <ECharts option={option_tabline}/>
                                </div>
                            </Tab>
                            <Tab label="转换率" value={2} style={{color:'#000000'}}>
                                <div style={{width:'100%',height:'350px',textAlign:'center'}}>
                                    <ECharts option={option_tabline}/>
                                </div>
                            </Tab>
