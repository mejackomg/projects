...
class RowPiecePage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            slideIndex: 0,
                    ...
                    height:this.context.muiTheme.palette.desktopSubheaderHeight}}
                       ...
                       <ToolbarGroup>
                           <Tabs
                               ...
                               >
                               <Tab label="排片统计" value={0}/>
                               <Tab label="智能排片" value={1}/>
                           </Tabs>
                       </ToolbarGroup>
...
RowPiecePage.contextTypes = {
    muiTheme: React.PropTypes.object,
}

RowPiecePage.childContextTypes = {
    muiTheme: React.PropTypes.object,
};

RowPiecePage.propTypes = {
