...
import FilmCard from './FilmCard_Forecast.jsx'
                    ...
                    height:this.context.muiTheme.palette.desktopSubheaderHeight}}
                        ...
                        <ToolbarGroup>
                            <Tabs
                                ...
                                >
                                <Tab label="票房统计" value={0}/>
                                <Tab label="大盘预测" value={1}/>
                            </Tabs>
                        </ToolbarGroup>
...
BoxOfficePage.contextTypes = {
    muiTheme: React.PropTypes.object,
}

BoxOfficePage.childContextTypes = {
    muiTheme: React.PropTypes.object,
};

BoxOfficePage.propTypes = {
