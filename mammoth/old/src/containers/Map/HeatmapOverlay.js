...
var viridis = require('scale-color-perceptual/hex/plasma.json');
var locations = require('../../../Data/heatmap.json');
...
module.exports = React.createClass({
  ...
  _redraw: function _redraw() {
    ...
    this.props.locations.forEach(function each(location) {
      var size = 30;//4 * Math.pow(2, this.props.zoom - 0);//.sizeAccessor(location);
      var intensity = location.attackcount/ 15000;//this.props.intensityAccessor(location);
